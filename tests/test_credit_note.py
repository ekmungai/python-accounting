...
from python_accounting.transactions import CreditNote
...
def test_credit_note_ledgers(session, entity, currency):
    """Tests credit note transaction ledger records"""
...
def test_credit_note_validation(session, entity, currency):
