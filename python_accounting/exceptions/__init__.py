...
class InvalidTransactionDateError(AccountingExeption):
    ...
    message = """The Transaction date cannot be at the exact start of the Reporting Period. Use a Balance object instead."""
...
class NegativeAmountError(AccountingExeption):
    ...
    def __init__(self, amount_class, attribute="amount") -> None:
        self.message = f"{amount_class} {attribute} cannot be negative."
        super().__init__()
